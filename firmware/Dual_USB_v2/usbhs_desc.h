...
/* USB Device Info - 伪装成无线鼠标接收器 */
#define DEF_USB_VID                   0x36A7
#define DEF_USB_PID                   0xA878
...
#define DEF_USBD_DEVICE_DESC_LEN      ( (uint16_t)HS_MyDevDescr[ 0 ] )
#define DEF_USBD_CONFIG_DESC_LEN      ( (uint16_t)HS_MyCfgDescr[ 2 ] + ( (uint16_t)HS_MyCfgDescr[ 3 ] << 8 ) )
#define DEF_USBD_REPORT_DESC_LEN_KB   0x3E
#define DEF_USBD_REPORT_DESC_LEN_MS   0x34
#define DEF_USBD_LANG_DESC_LEN        ( (uint16_t)HS_MyLangDescr[ 0 ] )
#define DEF_USBD_MANU_DESC_LEN        ( (uint16_t)HS_MyManuInfo[ 0 ] )
#define DEF_USBD_PROD_DESC_LEN        ( (uint16_t)HS_MyProdInfo[ 0 ] )
#define DEF_USBD_SN_DESC_LEN          ( (uint16_t)HS_MySerNumInfo[ 0 ] )
...
extern const uint8_t HS_MyDevDescr[ ];
extern const uint8_t HS_MyCfgDescr[ ];
extern const uint8_t KeyRepDesc[ ];
extern const uint8_t MouseRepDesc[ ];
extern const uint8_t MyQuaDesc[ ];
extern const uint8_t HS_MyLangDescr[ ];
extern const uint8_t HS_MyManuInfo[ ];
extern const uint8_t HS_MyProdInfo[ ];
extern const uint8_t HS_MySerNumInfo[ ];
