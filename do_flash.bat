...
echo.
echo [*] 开始烧录...
WCHISPTool_CH32Vxxx.exe --Device USB --Chip CH32V305 --Program "C:\Users\AnlangZ\ZCodeProject\mouse-forwarder\tools\firmware.hex" >> "C:\Users\AnlangZ\ZCodeProject\mouse-forwarder\tools\flash_log.txt" 2>&1
type "C:\Users\AnlangZ\ZCodeProject\mouse-forwarder\tools\flash_log.txt"
echo.
echo [*] 完成, 按任意键退出
pause >nul